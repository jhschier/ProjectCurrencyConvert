...
const convertValue = async () => {
  ...
  const endpoint =
    "https://economia.awesomeapi.com.br/json/last/BRL-USD,BRL-EUR,BRL-GBP,USD-BRL,USD-EUR,USD-GBP,EUR-BRL,EUR-USD,EUR-GBP,GBP-BRL,GBP-USD,GBP-EUR,BTC-BRL,BTC-USD,BTC-EUR,ETH-BRL,ETH-USD,ETH-EUR";
  ...
  if (selectCurrency1.value == "real1") {
    ...
    if (selectCurrency2.value == "dollar2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(inputCurrencyValue * BRLUSD);
    }
    ...
    if (selectCurrency2.value == "euro2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "EUR",
      }).format(inputCurrencyValue * BRLEUR);
    }
    ...
    if (selectCurrency2.value == "pound2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-UK", {
        style: "currency",
        currency: "GBP",
      }).format(inputCurrencyValue * BRLGBP);
    }
    ...
    if (selectCurrency2.value == "bitcoin2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "BTC",
      }).format((inputCurrencyValue * realValue) / bitcoinValue);
    }
    ...
    if (selectCurrency2.value == "ethereum2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "ETH",
      }).format((inputCurrencyValue * realValue) / ethereumValue);
    }
  }
  ...
  if (selectCurrency1.value == "dollar1") {
    ...
    if (selectCurrency2.value == "real2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("pt-BR", {
        style: "currency",
        currency: "BRL",
      }).format(inputCurrencyValue * USDBRL);
    }
    ...
    if (selectCurrency2.value == "euro2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "EUR",
      }).format(inputCurrencyValue * USDEUR);
    }
    ...
    if (selectCurrency2.value == "pound2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-UK", {
        style: "currency",
        currency: "GBP",
      }).format(inputCurrencyValue * USDGBP);
    }
    ...
    if (selectCurrency2.value == "bitcoin2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "BTC",
      }).format((inputCurrencyValue * dollarValue) / bitcoinValue);
    }
    ...
    if (selectCurrency2.value == "ethereum2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "ETH",
      }).format((inputCurrencyValue * dollarValue) / ethereumValue);
    }
  }
  ...
  if (selectCurrency1.value == "euro1") {
    ...
    if (selectCurrency2.value == "real2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("pt-BR", {
        style: "currency",
        currency: "BRL",
      }).format(inputCurrencyValue * EURBRL);
    }
    ...
    if (selectCurrency2.value == "dollar2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(inputCurrencyValue * EURUSD);
    }
    ...
    if (selectCurrency2.value == "pound2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-UK", {
        style: "currency",
        currency: "GBP",
      }).format(inputCurrencyValue * EURGBP);
    }
    ...
    if (selectCurrency2.value == "bitcoin2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "XBT",
      }).format((inputCurrencyValue * euroValue) / bitcoinValue);
    }
    ...
    if (selectCurrency2.value == "ethereum2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "ETH",
      }).format((inputCurrencyValue * euroValue) / ethereumValue);
    }
  }
  ...
  if (selectCurrency1.value == "pound1") {
    ...
    if (selectCurrency2.value == "real2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("pt-BR", {
        style: "currency",
        currency: "BRL",
      }).format(inputCurrencyValue * GBPBRL);
    }
    ...
    if (selectCurrency2.value == "dollar2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(inputCurrencyValue * GBPUSD);
    }
    ...
    if (selectCurrency2.value == "euro2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "EUR",
      }).format(inputCurrencyValue * GBPEUR);
    }
    ...
    if (selectCurrency2.value == "bitcoin2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "XBT",
      }).format((inputCurrencyValue * poundValue) / bitcoinValue);
    }
    ...
    if (selectCurrency2.value == "ethereum2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "ETH",
      }).format((inputCurrencyValue * poundValue) / ethereumValue);
    }
  }
  ...
  if (selectCurrency1.value == "bitcoin1") {
    ...
    if (selectCurrency2.value == "real2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("pt-BR", {
        style: "currency",
        currency: "BRL",
      }).format(inputCurrencyValue * BTCBRL);
    }
    ...
    if (selectCurrency2.value == "dollar2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(inputCurrencyValue * BTCUSD);
    }
    ...
    if (selectCurrency2.value == "euro2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "EUR",
      }).format(inputCurrencyValue * BTCEUR);
    }
    ...
    if (selectCurrency2.value == "pound2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-UK", {
        style: "currency",
        currency: "GBP",
      }).format((inputCurrencyValue * bitcoinValue) / poundValue);
    }
    ...
    if (selectCurrency2.value == "ethereum2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "ETH",
      }).format((inputCurrencyValue * bitcoinValue) / ethereumValue);
    }
  }
  ...
  if (selectCurrency1.value == "ethereum1") {
    ...
    if (selectCurrency2.value == "real2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("pt-BR", {
        style: "currency",
        currency: "BRL",
      }).format(inputCurrencyValue * ETHBRL);
    }
    ...
    if (selectCurrency2.value == "dollar2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(inputCurrencyValue * ETHUSD);
    }
    ...
    if (selectCurrency2.value == "euro2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "EUR",
      }).format(inputCurrencyValue * ETHEUR);
    }
    ...
    if (selectCurrency2.value == "pound2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("en-UK", {
        style: "currency",
        currency: "GBP",
      }).format((inputCurrencyValue * ethereumValue) / poundValue);
    }
    ...
    if (selectCurrency2.value == "bitcoin2") {
      currencyConverted.innerHTML = new Intl.NumberFormat("de-DE", {
        style: "currency",
        currency: "XBT",
      }).format((inputCurrencyValue * ethereumValue) / bitcoinValue);
    }
